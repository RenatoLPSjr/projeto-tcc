<?php
    ...
    class Usuario extends Model
    {
        ...
        {
            $query = 'insert into usuarios(nome, email, senha, tipo, especialidade, pix, telefone, areas, status) values(:nome, :email, :senha, :tipo, :especialidade, :pix, :telefone, :areas, 0)';
            $stmt = $this->db->prepare($query);
            $stmt->bindValue(':nome', $this->__get('nome'));
            $stmt->bindValue(':email', $this->__get('email'));
            $stmt->bindValue(':senha', $this->__get('senha'));
            $stmt->bindValue(':tipo', $this->__get('tipo'));
            $stmt->bindValue(':pix', $this->__get('pix'));
            $stmt->bindValue(':areas', $this->__get('areas'));
        ...
        {
            $query = 'insert into usuarios(nome, email, senha, tipo, especialidade, pix, telefone, sigla, areas, status) values(:nome, :email, :senha, :tipo, :especialidade, :pix, :telefone, :sigla, :areas, 1)';
            $stmt = $this->db->prepare($query);
            $stmt->bindValue(':nome', $this->__get('nome'));
            $stmt->bindValue(':email', $this->__get('email'));
            $stmt->bindValue(':senha', $this->__get('senha'));
        ...
        public function getGestao()
        {
            $query = "
                select id, nome, email, path_imagem, nome_imagem, especialidade from usuarios
                WHERE id NOT IN (1, 26, 27) and status = 1
            ";
            $stmt = $this->db->prepare($query);
            $stmt->execute();
        ...
        public function getGestaoNovo()
        {
            $query = "
                select id, nome, email, path_imagem, nome_imagem, especialidade from usuarios
                WHERE id NOT IN (1, 26, 27) and status = 0
            ";
            $stmt = $this->db->prepare($query);
            $stmt->execute();
        ...
        public function getGestaoEditar($id)
        {
            $query = "
                select id, nome, email, sigla, path_imagem, nome_imagem, especialidade, telefone, pix from usuarios
                WHERE id = :id
            ";
            $stmt = $this->db->prepare($query);
            $stmt->bindValue(':id', $id);
        ...
        public function getGestaoAceito($id)
        {
            $query = "
                update usuarios set status = 1, sigla = :sigla where id = :id
            ";
            $stmt = $this->db->prepare($query);
            $stmt->bindValue(':id', $id);
            $stmt->bindValue(':sigla', $this->__get('sigla'));
